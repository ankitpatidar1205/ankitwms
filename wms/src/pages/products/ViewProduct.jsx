                ...
                <Card className="rounded-2xl shadow-sm border-gray-100">
                    ...
                    {(product.ProductStocks || []).length === 0 ? (
                        ...
                        <Table size="small" dataSource={product.ProductStocks || []} rowKey="id" pagination={false} columns={[
                            ...
                            { title: 'Quantity', dataIndex: 'quantity', key: 'qty', render: (v) => v ?? '—' },
                        ]} />
                    )}
                </Card>
            ),
        ...
        <MainLayout>
            <div className="w-full space-y-6 animate-in fade-in duration-500 pb-12">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <Card size="small" className="rounded-xl"><div className="text-xs text-gray-500">Total Stock</div><div className="text-lg font-bold">{totalStock} units</div></Card>
